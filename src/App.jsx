...
function App() {
  ...
  const handleTestConnection = async () => {
    ...
    const config = {
      ...
      endpoint:
        ...
        PROVIDERS[providerConfig.provider]?.placeholder ||
        "",
    ...
    if (result.success) {
      addLog(
        `${PROVIDERS[providerConfig.provider].name} API test successful!`,
        "success",
      );
    } else {
      addLog(
        `${PROVIDERS[providerConfig.provider].name} API test failed: ${result.message}`,
        "error",
      );
    }
  };
  ...
  const processFile = async (file) => {
    ...
    try {
      ...
      setStats(fileStats);
      addLog(
        `Loaded ${file.name} with ${fileStats.totalStrings} strings`,
        "success",
      );
    } catch (error) {
  ...
  const handleTranslate = async () => {
    if (!currentApiKey) {
      addLog(
        `Please enter your ${PROVIDERS[providerConfig.provider].name} API key`,
        "error",
      );
      return;
    }
  ...
  const handleSaveEdit = () => {
    ...
    addLog(
      `Updated ${editDialog.lang} translation for "${editDialog.key}"`,
      "success",
    );
  };
    ...
    const entries = Object.entries(xcstringsData.strings)
      ...
      .filter((item) => {
        ...
        if (searchQuery) {
          ...
          if (!matchesKey && !matchesEnglish && !matchesTranslation)
            return false;
        }
    ...
    <div className="min-h-svh bg-background">
      ...
      <SidebarProvider>
        ...
        <SidebarInset>
          ...
          <main className="flex-1 p-6 md:p-8 lg:p-10">
            <div
              className={`mx-auto space-y-8 ${activePage === "screenshots" ? "w-full max-w-none" : "max-w-6xl"}`}
            >
              ...
              <div
                className={
                  activePage === "screenshots" ? "space-y-6" : "hidden"
                }
              >
                <ScreenshotMaker
                    ...
                    <div className="relative flex flex-col md:flex-row md:items-center gap-6">
                      <div className="flex-1">
                        ...
                        <p className="text-muted-foreground max-w-xl">
                          ...
                          file, translate to 20+ languages with AI, and export
                          back to Xcode instantly.
                        </p>
                      </div>
                      {stats && (
                        ...
                        <CardHeader className="pb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <CardDescription>
                                Configure your AI service in the sidebar
                              </CardDescription>
                            </div>
                          </div>
                        </CardHeader>
                          ...
                          <div className="flex items-center gap-3 flex-wrap">
                            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-muted/50">
                              <span className="text-sm font-medium">
                                {PROVIDERS[providerConfig.provider]?.name}
                              </span>
                        ...
                        <CardHeader className="pb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <CardDescription>
                                Brand names, app names, or terms that should
                                stay untranslated
                              </CardDescription>
                            </div>
                          </div>
                        ...
                        <CardContent className="space-y-4">
                          <div className="flex gap-2">
                            <Input
                              ...
                              onChange={(e) =>
                                setNewProtectedWord(e.target.value)
                              }
                              onKeyDown={(e) =>
                                e.key === "Enter" && addProtectedWord()
                              }
                        ...
                        <CardHeader className="pb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <CardDescription>
                                Load your Xcode localization file to get started
                              </CardDescription>
                            </div>
                          </div>
                        </CardHeader>
                                ...
                                <div className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-amber-500/10 text-amber-500 ml-auto">
                                  ...
                                  <span className="text-sm font-medium">
                                    {selectedLanguages.reduce((acc, lang) => {
                                      const missing =
                                        stats.totalStrings -
                                        (stats.translationCounts[lang] || 0);
                                      return acc + missing;
                                    }, 0)}{" "}
                                    translations needed
                                  </span>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <CardDescription>
                                  Select languages to translate your content
                                  into
                                </CardDescription>
                              </div>
                            </div>
                        ...
                        <CardContent>
                          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                            {SUPPORTED_LANGUAGES.map((lang) => {
                              const translated =
                                stats?.translationCounts?.[lang.code] || 0;
                              const missing = stats
                                ? stats.totalStrings - translated
                                : 0;
                        ...
                        <CardHeader className="pb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <CardDescription>
                                Run AI translation and download your localized
                                file
                              </CardDescription>
                            </div>
                          </div>
                        ...
                        <CardHeader className="pb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <CardDescription>
                                Track translation progress and events
                              </CardDescription>
                            </div>
                          </div>
                        </CardHeader>
                        ...
                        <CardHeader className="pb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <CardDescription>
                                Browse, search, and edit all your translations
                              </CardDescription>
                            </div>
                          </div>
                        </CardHeader>
                                      ...
                                      <div className="flex flex-col items-center text-muted-foreground">
                                        ...
                                        <p className="text-sm font-medium">
                                          {xcstringsData
                                            ...
                                            : "Load a file to see translations"}
                                        </p>
                                        <p className="text-xs mt-1">
                                          {xcstringsData
                                            ? "Try adjusting your search or filters"
                                            : "Upload a .xcstrings file to get started"}
                                        </p>
                                      </div>
                                    </TableCell>
                                  </TableRow>
                                  ...
                                  paginatedTranslations.map((item) => (
                                    ...
                                    >
                                      <TableCell className="font-mono text-xs align-top py-3">
                                        <div
                                          className="max-w-[150px] truncate text-muted-foreground group-hover:text-foreground transition-colors"
                                          title={item.key}
                                        >
                                          {item.key}
                                        </div>
      ...
      {activePage === "xcstrings" && (
        <Dialog
          ...
          onOpenChange={(open) =>
            !open && setEditDialog({ ...editDialog, open: false })
          }
        >
            ...
            <DialogHeader className="p-6 pb-4 border-b border-border/50 bg-muted/30">
              <div className="flex items-center gap-3">
                <span className="text-3xl">
                  {
                    SUPPORTED_LANGUAGES.find((l) => l.code === editDialog.lang)
                      ?.flag
                  }
                </span>
                <div>
            ...
            <div className="p-6 space-y-5">
              <div className="p-4 rounded-xl bg-muted/30 border border-border/50 space-y-3">
                <div>
                  ...
                  <p className="font-mono text-sm break-all mt-1 text-muted-foreground">
                    {editDialog.key}
                  </p>
                </div>
                <div className="pt-2 border-t border-border/50">
                  ...
                  <p className="text-sm mt-1">
                    {xcstringsData?.strings?.[editDialog.key]?.localizations?.en
                      ?.stringUnit?.value || editDialog.key}
                  </p>
                </div>
              </div>
